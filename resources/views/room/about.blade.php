@include('room.navbar')
    ...
    <section class="cs_page_heading cs_primary_bg cs_bg_filed cs_center" data-src="assets/img/page_heading_bg_about.jpg">
      <div class="container">
      ...
      <div class="container">
        <div class="cs_about cs_style_3">
          <div class="cs_section_heading cs_style_1 text-center">
            ...
            <img src="assets/img/about_us_1.jpg" alt="" class="cs_about_img">
    ...
    <a href="https://www.youtube.com/embed/UJEUwEJ6gH4" class="cs_video_block cs_style_1 cs_video_open text-center cs_center position-relative">
      <h2 class="cs_video_block_title cs_fs_150 mb-0 position-relative cs_zindex_3">SEAPEARL</h2>
      <div class="cs_video_block_bg h-100 w-100 position-absolute start-0 top-0 cs_bg_filed cs_primary_bg" data-src="assets/img/video_bg_1.jpg"></div>
    ...
    <section>
      ...
      <div class="container">
        <div class="cs_section_heading cs_style_1 text-center">
          <p class="cs_section_subtitle cs_medium cs_letter_spacing_1 cs_mb_28 cs_mb_lg_15 text-uppercase">OUR SERVICES</p>
          <h2 class="cs_fs_67 mb-0">Explore Our Exclusive Resort Facilities</h2>
        </div>
        <div class="cs_height_60 cs_height_lg_40"></div>
        <ul class="cs_list cs_style_2 cs_mp_0">
          <li class="position-relative cs_custom_pointer_wrap">
            <a class='cs_list_in d-block' href='restaurant.html'>
              <h2 class="cs_list_title mb-0 cs_fs_50 cs_secondary_color">Luxury Accommodations</h2>
              <span class="cs_list_icon cs_center rounded-circle cs_ternary_bg cs_primary_color">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.3137 0.999768C13.3137 0.447483 12.866 -0.000232004 12.3137 -0.000232257L3.31371 -0.000231456C2.76142 -0.000231793 2.31371 0.447484 2.31371 0.999768C2.31371 1.55205 2.76142 1.99977 3.31371 1.99977L11.3137 1.99977L11.3137 9.99977C11.3137 10.5521 11.7614 10.9998 12.3137 10.9998C12.866 10.9998 13.3137 10.5521 13.3137 9.99977L13.3137 0.999768ZM1.70711 13.0206L13.0208 1.70688L11.6066 0.292661L0.292893 11.6064L1.70711 13.0206Z" fill="currentColor"/>
                </svg>
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.3137 0.999768C13.3137 0.447483 12.866 -0.000232004 12.3137 -0.000232257L3.31371 -0.000231456C2.76142 -0.000231793 2.31371 0.447484 2.31371 0.999768C2.31371 1.55205 2.76142 1.99977 3.31371 1.99977L11.3137 1.99977L11.3137 9.99977C11.3137 10.5521 11.7614 10.9998 12.3137 10.9998C12.866 10.9998 13.3137 10.5521 13.3137 9.99977L13.3137 0.999768ZM1.70711 13.0206L13.0208 1.70688L11.6066 0.292661L0.292893 11.6064L1.70711 13.0206Z" fill="currentColor"/>
                </svg>                
            ...
            <div class="cs_mouse_point cs_style_3"><img src="assets/img/service_img_6.jpg" alt="Service"></div>
          </li>
          <li class="position-relative cs_custom_pointer_wrap">
            <a class='cs_list_in d-block' href='restaurant.html'>
              <h2 class="cs_list_title mb-0 cs_fs_50 cs_secondary_color">Casabalina Restaurant</h2>
              <span class="cs_list_icon cs_center rounded-circle cs_ternary_bg cs_primary_color">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.3137 0.999768C13.3137 0.447483 12.866 -0.000232004 12.3137 -0.000232257L3.31371 -0.000231456C2.76142 -0.000231793 2.31371 0.447484 2.31371 0.999768C2.31371 1.55205 2.76142 1.99977 3.31371 1.99977L11.3137 1.99977L11.3137 9.99977C11.3137 10.5521 11.7614 10.9998 12.3137 10.9998C12.866 10.9998 13.3137 10.5521 13.3137 9.99977L13.3137 0.999768ZM1.70711 13.0206L13.0208 1.70688L11.6066 0.292661L0.292893 11.6064L1.70711 13.0206Z" fill="currentColor"/>
                </svg>
            ...
            <div class="cs_mouse_point cs_style_3"><img src="assets/img/service_img_7.jpg" alt="Service"></div>
          </li>
          <li class="position-relative cs_custom_pointer_wrap">
            <a class='cs_list_in d-block' href='restaurant.html'>
              <h2 class="cs_list_title mb-0 cs_fs_50 cs_secondary_color">Business and Event Facilities</h2>
              <span class="cs_list_icon cs_center rounded-circle cs_ternary_bg cs_primary_color">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.3137 0.999768C13.3137 0.447483 12.866 -0.000232004 12.3137 -0.000232257L3.31371 -0.000231456C2.76142 -0.000231793 2.31371 0.447484 2.31371 0.999768C2.31371 1.55205 2.76142 1.99977 3.31371 1.99977L11.3137 1.99977L11.3137 9.99977C11.3137 10.5521 11.7614 10.9998 12.3137 10.9998C12.866 10.9998 13.3137 10.5521 13.3137 9.99977L13.3137 0.999768ZM1.70711 13.0206L13.0208 1.70688L11.6066 0.292661L0.292893 11.6064L1.70711 13.0206Z" fill="currentColor"/>
                </svg>
            ...
            <div class="cs_mouse_point cs_style_3"><img src="assets/img/service_img_8.jpg" alt="Service"></div>
          </li>
          <li class="position-relative cs_custom_pointer_wrap">
            <a class='cs_list_in d-block' href='restaurant.html'>
              <h2 class="cs_list_title mb-0 cs_fs_50 cs_secondary_color">SeaPearl Spa and Wellness</h2>
              <span class="cs_list_icon cs_center rounded-circle cs_ternary_bg cs_primary_color">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.3137 0.999768C13.3137 0.447483 12.866 -0.000232004 12.3137 -0.000232257L3.31371 -0.000231456C2.76142 -0.000231793 2.31371 0.447484 2.31371 0.999768C2.31371 1.55205 2.76142 1.99977 3.31371 1.99977L11.3137 1.99977L11.3137 9.99977C11.3137 10.5521 11.7614 10.9998 12.3137 10.9998C12.866 10.9998 13.3137 10.5521 13.3137 9.99977L13.3137 0.999768ZM1.70711 13.0206L13.0208 1.70688L11.6066 0.292661L0.292893 11.6064L1.70711 13.0206Z" fill="currentColor"/>
                </svg>
            ...
            <div class="cs_mouse_point cs_style_3"><img src="assets/img/service_img_9.jpg" alt="Service"></div>
          </li>
          <li class="position-relative cs_custom_pointer_wrap">
            <a class='cs_list_in d-block' href='restaurant.html'>
              <h2 class="cs_list_title mb-0 cs_fs_50 cs_secondary_color">Infinity Pool</h2>
              <span class="cs_list_icon cs_center rounded-circle cs_ternary_bg cs_primary_color">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.3137 0.999768C13.3137 0.447483 12.866 -0.000232004 12.3137 -0.000232257L3.31371 -0.000231456C2.76142 -0.000231793 2.31371 0.447484 2.31371 0.999768C2.31371 1.55205 2.76142 1.99977 3.31371 1.99977L11.3137 1.99977L11.3137 9.99977C11.3137 10.5521 11.7614 10.9998 12.3137 10.9998C12.866 10.9998 13.3137 10.5521 13.3137 9.99977L13.3137 0.999768ZM1.70711 13.0206L13.0208 1.70688L11.6066 0.292661L0.292893 11.6064L1.70711 13.0206Z" fill="currentColor"/>
                </svg>
            ...
            <div class="cs_mouse_point cs_style_3"><img src="assets/img/service_img_10.jpg" alt="Service"></div>
          </li>
          <li class="position-relative cs_custom_pointer_wrap">
            <a class='cs_list_in d-block' href='restaurant.html'>
              <h2 class="cs_list_title mb-0 cs_fs_50 cs_secondary_color">24-Hour Reception and Security</h2>
              <span class="cs_list_icon cs_center rounded-circle cs_ternary_bg cs_primary_color">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.3137 0.999768C13.3137 0.447483 12.866 -0.000232004 12.3137 -0.000232257L3.31371 -0.000231456C2.76142 -0.000231793 2.31371 0.447484 2.31371 0.999768C2.31371 1.55205 2.76142 1.99977 3.31371 1.99977L11.3137 1.99977L11.3137 9.99977C11.3137 10.5521 11.7614 10.9998 12.3137 10.9998C12.866 10.9998 13.3137 10.5521 13.3137 9.99977L13.3137 0.999768ZM1.70711 13.0206L13.0208 1.70688L11.6066 0.292661L0.292893 11.6064L1.70711 13.0206Z" fill="currentColor"/>
                </svg>
              ...
              <div class="cs_slider_wrapper">
                  ...
                  <div class="cs_testimonial cs_style_1 text-center position-relative">
                    <div class="position-relative cs_zindex_2">
                      <div class="cs_testimonial_avatar cs_mb_50 cs_mb_lg_20">
                        <img src="assets/img/avatar_1.png" alt="Avatar" class="cs_mb_10">
                        <h3 class="cs_fs_28 mb-0">Angrew Bolar</h3>
                        <p class="mb-0">Hotel Guest</p>
                      </div>
                      <blockquote class="cs_testimonial_blockquote cs_fs_50 cs_primary_font cs_primary_color fst-normal cs_mb_75 cs_mb_lg_30">Exceptional resort! From the exquisite dining to the serene spa and the  captivating infinity pool, every moment was pure bliss. Impeccable  service and breathtaking views – a perfect escape!</blockquote>
                ...
                <div class="cs_slide">
                  <div class="cs_testimonial cs_style_1 text-center position-relative">
                    <div class="position-relative cs_zindex_2">
                      <div class="cs_testimonial_avatar cs_mb_50 cs_mb_lg_20">
                        <img src="assets/img/avatar_2.png" alt="Avatar" class="cs_mb_10">
                        <h3 class="cs_fs_28 mb-0">Cecilia Brooks</h3>
                        <p class="mb-0">Hotel Guest</p>
                      </div>
                      <blockquote class="cs_testimonial_blockquote cs_fs_50 cs_primary_font cs_primary_color fst-normal cs_mb_75 cs_mb_lg_30">Exceptional resort! From the exquisite dining to the serene spa and the  captivating infinity pool, every moment was pure bliss. Impeccable  service and breathtaking views – a perfect escape!</blockquote>
                      <div class="cs_height_75 cs_height_lg_30"></div>
                      <div class="cs_rating cs_green_color" data-rating="4.5">
                        <i class="fa-regular fa-star"></i>
                        <i class="fa-regular fa-star"></i>
                        <i class="fa-regular fa-star"></i>
                        <i class="fa-regular fa-star"></i>
                ...
                <div class="cs_slide">
                  <div class="cs_testimonial cs_style_1 text-center position-relative">
                    <div class="position-relative cs_zindex_2">
                      <div class="cs_testimonial_avatar cs_mb_50 cs_mb_lg_20">
                        <img src="assets/img/avatar_3.png" alt="Avatar" class="cs_mb_10">
                        <h3 class="cs_fs_28 mb-0">Carlo Basile</h3>
                        <p class="mb-0">VIP Guest</p>
                      </div>
                      <blockquote class="cs_testimonial_blockquote cs_fs_50 cs_primary_font cs_primary_color fst-normal cs_mb_75 cs_mb_lg_30">Exceptional resort! From the exquisite dining to the serene spa and the  captivating infinity pool, every moment was pure bliss. Impeccable  service and breathtaking views – a perfect escape!</blockquote>
                      <div class="cs_height_75 cs_height_lg_30"></div>
                      <div class="cs_rating cs_green_color" data-rating="4.5">
        ...
        <div class="row">
          <div class="col-lg-8 offset-lg-2">
            <div class="cs_newsletter cs_style_1 text-center">
              <span class="cs_newsletter_icon cs_center cs_accent_bg rounded-circle cs_mb_26">
